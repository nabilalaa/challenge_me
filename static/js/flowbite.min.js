						...
						fn: function (t) {
							...
							null !=
								...
								((e.modifiersData.popperOffsets.x +=
									u),
								(e.modifiersData.popperOffsets.y +=
									p)),
								(e.modifiersData[o] = l);
						}
					};
					...
					var n = {
						...
						o = (function () {
							...
							return (
								...
								(t.prototype._getActiveItem =
									function () {
										return this
											._activeItem;
									}),
								(t.prototype._setActiveItem =
									function (t) {
										var e,
											i,
											n = this;
					...
					var n = {
						...
						o = (function () {
							...
							return (
								...
								(t.prototype.isHidden =
									function () {
										return !this
											._visible;
									}),
								(t.prototype.isVisible =
									function () {
										return this
											._visible;
									}),
								(t.prototype._getTriggerEventTypes =
									function (t) {
										switch (t) {
											case "hover":
											default:
					...
					var n = {
						...
						o = (function () {
							...
							return (
								...
								(t.prototype._destroyBackdropEl =
									function () {
										this._visible &&
											document
												.querySelector(
					...
					var r = i(853),
						...
						a = (function () {
							...
							return (
								...
								(t.prototype._handleClickOutside =
									function (t, e) {
										var i = t.target,
											n =
												this
					...
					var n = {
						...
						o = (function () {
							...
							return (
								...
								(t.prototype._handleOutsideClick =
									function (t) {
										(t ===
											this
												._targetEl ||
					...
					var n = {
						...
						o = (function () {
							...
							return (
								...
								(t.prototype.getActiveTab =
									function () {
										return this
											._activeTab;
									}),
								(t.prototype._setActiveTab =
									function (t) {
										this._activeTab = t;
									}),
